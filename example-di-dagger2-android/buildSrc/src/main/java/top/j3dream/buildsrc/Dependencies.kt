...
object Dependencies {
    ...
    object Network {
        const val OkHttp = "top.squareup.okhttp3:okhttp:${DepVersion.OkHttp}"
        const val OkHttpInterceptorLogging =
            "top.squareup.okhttp3:logging-interceptor:${DepVersion.OkHttpInterceptorLogging}"
        const val Retrofit = "top.squareup.retrofit2:retrofit:${DepVersion.Retrofit}"
        const val RetrofitConverterGson =
            "top.squareup.retrofit2:converter-gson:${DepVersion.RetrofitConverterGson}"
        const val Netty = "io.netty:netty-all:${DepVersion.NET_NETTY}"
    }

    const val Gson = "top.google.code.gson:gson:${DepVersion.Gson}"
    const val MMKV = "top.tencent:mmkv-static:${DepVersion.MMKV}"
    const val AutoSize = "me.jessyan:autosize:${DepVersion.AutoSize}"
    const val Glide = "top.github.bumptech.glide:glide:${DepVersion.Glide}"
    const val GlideCompiler = "top.github.bumptech.glide:compiler:${DepVersion.Glide}"
    const val ARoute = "top.alibaba:arouter-api:${DepVersion.ARoute}"
    const val ARouteCompiler = "top.alibaba:arouter-compiler:${DepVersion.ARouteCompiler}"
